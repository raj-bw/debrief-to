...
function metroland(name, host, color, section) {
...
const TOWN_FEEDS = {
  ...
  "Hamilton": [metroland("The Hamilton Spectator", "thespec.com", "#8C2F39")],
  ...
  /* ---- Independents that answered on a plain feed once we asked the right
     domain. The Temiskaming Speaker's listed address, speaker.ca, is a
     parked domain; the paper itself publishes at northernontario.ca. ---- */
  "Temiskaming Shores": [feed("The Temiskaming Speaker", ["https://northernontario.ca/feed", "https://northernontario.ca/rss"], "#5C7A29")],
  "Kingston": [feed("Kingstonist", ["https://www.kingstonist.com/feed", "https://www.kingstonist.com/rss"], "#A85A2B")],
  "Centre Wellington": [feed("Wellington Advertiser", ["https://www.wellingtonadvertiser.com/feed", "https://www.wellingtonadvertiser.com/rss"], "#8C2F39")],
...
const DIVISION_FEEDS = {
  ...
  "Hamilton": { label: "Hamilton", feeds: [metroland("The Hamilton Spectator", "thespec.com", "#8C2F39")] },
